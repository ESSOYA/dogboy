...
//         } catch (err) {
//           console.warn(`Image de statut introuvable : ${imagePath}`);
//         }
//       }
//       if (validImages.length === 0) {
//         console.error('Aucune image de statut valide trouvée.');
//         return;
//       }
...
//       console.log(`Statut WhatsApp mis à jour avec ${randomImagePath}`);
//     } catch (err) {
...
//       const cacheKey = `${messageId}:${sender}`;
